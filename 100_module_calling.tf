...
module "cml" {
  ...
  dc-a-bgw101-p2p-Router01    = module.efficient_ip.dc-a-bgw101-p2p-Router01
  dc-a-bgw102-p2p-Router01    = module.efficient_ip.dc-a-bgw102-p2p-Router01
  ...
  ndfc_routing_loopback_range = local.ndfc_routing_loopback_range
  dc-a-bgw101-loopback0       = module.efficient_ip.dc-a-bgw101-loopback0
  dc-a-bgw102-loopback0       = module.efficient_ip.dc-a-bgw102-loopback0
